...
public class SumaNumerosServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		response.getWriter().append("<title>Servlet</title>");
		response.getWriter().append("</head>");
		...
		int numero1;
		int numero2;
		String miComentario=request.getParameter("comentario");
		...
		miComentario=request.getParameter("comentario");
		...
		*/
		...
		response.getWriter().append("</br>");
		response.getWriter().append("<br>");
		response.getWriter().append("Comentario: "+miComentario);
		response.getWriter().append("</br>");
		response.getWriter().append("<br>");
